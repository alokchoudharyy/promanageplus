...
export default function EmployeeSettingsPage() {
  ...
  try {
    ...
    // ✅ FIXED: Simple page reload instead of refreshProfile()
    setTimeout(() => {
              ...
              <form onSubmit={handleProfileUpdate} className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    required
                    className="w-full border border-gray-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                ...
                <div className="pt-4">
                  <button
                    type="submit"
                    disabled={loading}
                    className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-2 rounded-md hover:opacity-90 transition disabled:opacity-50"
                  >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Get notified 24 hours before task deadlines
                    </p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" className="sr-only peer" defaultChecked />
                ...
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                  <div>
                    <h3 className="font-medium text-gray-900">Task Comments</h3>
                    <p className="text-sm text-gray-600">
